...
(async()=>{
	const views = await getData('https://api.github.com/repos/nach131/ft_printf/traffic/views');
	const clone = await getData('https://api.github.com/repos/nach131/ft_printf/traffic/clones');
